...
import org.wso2.carbon.identity.post.authn.handler.passwordPolicyEnforcer.internal.EnforcePasswordResetPostAuthenticationHandlerDataHolder;
...
import static org.wso2.carbon.identity.post.authn.handler.passwordPolicyEnforcer.PasswordPolicyConstants.ErrorMessages.*;
    ...
    private static int getPasswordExpiryInDays(String tenantDomain)
        ...
        try {
            ...
            if (passwordExpiryInDaysConfiguredValue != null) {
                ...
                return PasswordPolicyConstants.CONNECTOR_CONFIG_PASSWORD_EXPIRY_IN_DAYS_DEFAULT_VALUE;
