...
import org.wso2.carbon.identity.post.authn.handler.resetPasswordEnforcer.internal.
        EnforcePasswordResetPostAuthenticationHandlerDataHolder;
...
import static org.wso2.carbon.identity.post.authn.handler.resetPasswordEnforcer.PasswordPolicyConstants.
        ErrorMessages.ERROR_WHILE_READING_SYSTEM_CONFIGURATIONS;
import static org.wso2.carbon.identity.post.authn.handler.resetPasswordEnforcer.PasswordPolicyConstants.
        ErrorMessages.ERROR_WHILE_GETTING_FEDERATED_USERNAME;
import static org.wso2.carbon.identity.post.authn.handler.resetPasswordEnforcer.PasswordPolicyConstants.
        ErrorMessages.ERROR_WHILE_GETTING_USER_STORE_DOMAIN;
import static org.wso2.carbon.identity.post.authn.handler.resetPasswordEnforcer.PasswordPolicyConstants.
        ErrorMessages.ERROR_WHILE_GETTING_CLAIM_MAPPINGS;
...
public class EnforcePasswordResetAuthenticationHandler extends AbstractPostAuthnHandler {
    ...
    public PostAuthnHandlerFlowStatus handle(HttpServletRequest httpServletRequest,
        ...
        if (!isPasswordExpiryEnabled(tenantDomain)) {
            return PostAuthnHandlerFlowStatus.SUCCESS_COMPLETED;
        }
     ...
     */
    private boolean isPasswordExpiryEnabled(String tenantDomain) throws PostAuthenticationFailedException {
        try {

            return Boolean.parseBoolean(PasswordPolicyUtils.getResidentIdpProperty(tenantDomain,
    ...
    private static void validateUser(AuthenticatedUser authenticatedUser) throws PostAuthenticationFailedException {
        ...
        if (authenticatedUser == null) {
            throw new PostAuthenticationFailedException(ERROR_WHILE_GETTING_FEDERATED_USERNAME.getCode(),
                    ERROR_WHILE_GETTING_FEDERATED_USERNAME.getMessage());
        }
    }
