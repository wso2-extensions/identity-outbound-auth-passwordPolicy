...
public class PasswordChangeUtilsTest {
    ...
    public void testGetPasswordExpiryPropertyNames() {
        ...
        String[] passwordExpiryPropertyNames = PasswordChangeUtils.getPasswordExpiryPropertyNames();

        Assert.assertEquals(passwordExpiryPropertyNames.length, 1);
        Assert.assertEquals(passwordExpiryPropertyNames[0],
                PasswordChangeEnforceConstants.CONNECTOR_CONFIG_PASSWORD_EXPIRY_IN_DAYS);
    }
}
